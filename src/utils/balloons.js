...
import prywatne_btn from '@/assets/prywatne_btn.png'
  ...
  baloons.push(new Ballon(sklepy_btn, 'HANDEL-SKLEPY', '/portfolio/HandelSklepy', '#c09200'))
  baloons.push(new Ballon(prywatne_btn, 'INWESTYCJE PRYWATNE', '/portfolio/InvestycjePrywatne', '#385723'))
